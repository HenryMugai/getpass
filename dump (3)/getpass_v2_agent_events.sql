...
CREATE TABLE `agent_events` (
  ...
  CONSTRAINT `agent_events_ibfk_1` FOREIGN KEY (`agent_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `agent_events_ibfk_2` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2026-05-06 10:40:39
